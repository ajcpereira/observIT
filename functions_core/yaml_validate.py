...
class AllowedMetrics:
    allowed_metrics = {
        'eternus_cs8000': [['fs_io','fs', 'cpu', 'mem', 'drives', 'medias', 'pvgprofile'], ['eternus_cs8000.eternus_cs8000_fs_io','linux_os.linux_os_fs','linux_os.linux_os_cpu', 'linux_os.linux_os_mem', 'eternus_cs8000.eternus_cs8000_drives', 'eternus_cs8000.eternus_cs8000_medias', 'eternus_cs8000.eternus_cs8000_pvgprofile']],
